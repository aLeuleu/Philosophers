...
static void init_one_philo(t_philo *philo, int id, t_philos_params *params, int *error);
static void set_all_left_forks(t_philo *philos, t_philos_params *params, int *error);
